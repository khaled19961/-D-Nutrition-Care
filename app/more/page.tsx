...
export default function MorePage() {
  return <SiteChrome><main>
    <section className="page-hero"><div className="container"><span>المزيد</span><h1>كل ما تحتاجه في مكان واحد</h1><p>روابط الحساب والخدمات والمحتوى والمعلومات المساعدة.</p></div></section>
