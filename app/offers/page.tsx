...
export default async function OffersPage() {
  ...
  return <SiteChrome><main><section className="moving-strip"><div className="moving-strip-track"><span>برامج غذائية منشورة فعلياً</span><span>اختر البرنامج ثم انتقل للحجز</span><span>لا توجد عروض أو أسعار تجريبية</span><span>برامج غذائية منشورة فعلياً</span><span>اختر البرنامج ثم انتقل للحجز</span><span>لا توجد عروض أو أسعار تجريبية</span></div></section>
